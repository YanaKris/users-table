...
export const COLUMNS = [
  ...
  { key: 'firstName',  label: 'Имя',      sortField: 'firstName', width: 130, getValue: (u) => u.firstName },
  { key: 'maidenName', label: 'Отчество', sortField: 'maidenName', width: 130, getValue: (u) => u.maidenName },
  { key: 'age',        label: 'Возраст',  sortField: 'age',       align: 'right', width: 80, getValue: (u) => u.age },
  ...
  { key: 'email',      label: 'Email',    sortField: null,        width: 220, getValue: (u) => u.email },
